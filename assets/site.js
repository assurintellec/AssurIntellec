...
function applyTheme(site) {
  ...
  const map = {
    ...
    hero_min_height: ['--hero-height','px'], hero_overlay_opacity: ['--hero-overlay','value'], instagram_width: ['--instagram-width','px'], instagram_height: ['--instagram-height','px'],
...
function renderInstagram(site) {
  ...
  const embedUrl =
    `https://www.instagram.com/reel/${encodeURIComponent(id)}/embed/captioned/?hidecaption=true`;
